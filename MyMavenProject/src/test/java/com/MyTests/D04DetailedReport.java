...
public class D04DetailedReport {
	WebDriver driver;
	...
	public void loginToOHRM_Success() throws InterruptedException {
		test = report.createTest("OHRM Login Success");
	...
	public void loginToOHRM_Fail() {
		test = report.createTest("OHRM Login Fail");

		driver.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys("Riya");
		driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("riya123");
		driver.findElement(By.xpath("//button[@type='submit']")).sendKeys(Keys.ENTER);
